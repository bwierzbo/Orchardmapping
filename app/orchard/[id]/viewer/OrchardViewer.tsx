...
export default function OrchardViewer({ orchard, allOrchards, initialTrees, canEdit }: OrchardViewerProps) {
  ...
  const [trees, setTrees] = useState<TreeDetails[]>(initialTrees as unknown as TreeDetails[]);
